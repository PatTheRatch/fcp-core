...
| `GET /projections/sources` | signed in, for `?season=` | every pool he may plan on: BBM only for the owner of the captures, ESPN, his uploads, his composites (one with BBM in it only for BBM's owner) |
