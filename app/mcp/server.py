    ...
    *,
    ...
    @mcp.tool(
        description=(
            ...
            "what fixing them in costs; the best roster at his prices. `sources` lists "
            "every pool he may plan on -- BBM, ESPN, his uploads and his composites (his "
            "own blends of other sources with his weights) -- and `source` names one: "
            "bbm, espn, upload:<set id>, composite:<set id>, or a source's own name "
            "(default: the newest stored BBM capture). A plan on Basketball Monster, or "
            "on a composite with BBM in it, is paid and only for the owner of that "
